...
export default function CollectionCard({
  ...
  return isLoading ? (
    <Card className="inline-flex flex-col w-[250px] min-h-[550px] bg-[var(--foreground)] justify-center items-center">Loading...</Card>
  ) : (
    <Card key={key} className="inline-flex flex-col w-[250px] min-h-[550px] bg-[var(--foreground)]">
